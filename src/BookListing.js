  ...
  return (
    <div className="Main">
      ...
      <div className="Listing">
        <img alt="deathnote" src="https://images-na.ssl-images-amazon.com/images/I/51cUNf8zukL._SX379_BO1,204,203,200_.jpg" height="300" />
        <h>
          Book Name:
          {booklisting[0]}
        </h>
